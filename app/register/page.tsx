  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-20 right-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-[#A3C4F3]/8 rounded-full blur-[100px] sm:blur-[120px]" />
        <div className="absolute top-1/2 left-5 sm:left-10 w-60 h-60 sm:w-80 sm:h-80 bg-[#7FA0E3]/8 rounded-full blur-[80px] sm:blur-[100px]" />
        <div className="absolute bottom-20 right-5 sm:right-10 w-64 h-64 sm:w-96 sm:h-96 bg-[#7FA0E3]/6 rounded-full blur-[100px] sm:blur-[130px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-sm px-4 sm:px-0">
        ...
        <Card className="backdrop-blur-lg bg-white/5 border-white/10 shadow-2xl">
          <CardHeader className="space-y-1 text-center pb-4 sm:pb-6">
            <CardTitle className="text-lg sm:text-xl text-white">Регистрация</CardTitle>
            <CardDescription className="text-zinc-400 text-xs sm:text-sm">Создайте новый аккаунт</CardDescription>
          </CardHeader>
          <CardContent>
            {errors.general && (
